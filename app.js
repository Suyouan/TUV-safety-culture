...
class App {
    ...
    goToLayer3(signId, pushHistory = true) {
        ...
        if (sign.Category.includes("Warning sign") || sign.Category.includes("Warning sign") || sign.Measures !== undefined) {
    ...
    openAddSignModal() {
        ...
        let measures = "";
        if (category.includes("Warning sign") || category.includes("Warning sign")) {
